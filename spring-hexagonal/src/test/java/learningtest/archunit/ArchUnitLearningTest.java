...
public class ArchUnitLearningTest {
    ...
    void application(JavaClasses classes) {
        // 앞 뒤 ".." 은 무슨 패키지가 나오든 상관 없이 패키지 이름이 application 이면 됨
        /**
         * application 안에 있는 클래스들은
         * 자신을 의존하는 클래스가 application 또는 adapter 패키지 안에만 존재해야한다.
         */
    ...
    /**
     * application 클래스는 adapter 의 클래스를 의존하면 안된다.
     */
    @ArchTest
    ...
    /**
     * domain 클래스는 domain, java 클래스에만 의존해야한다.
     */
    @ArchTest
